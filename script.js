...
if (d1) d1.addEventListener("click", () => window.location.href = "projects.html");
if (c1) c1.addEventListener("click", () => window.location.href = "contact.html");
if (cardbtn) cardbtn.addEventListener("click", () => window.location.href = "projects.html");
if (cardbtn2) cardbtn2.addEventListener("click", () => window.location.href = "projects.html");
if (cardbtn3) cardbtn3.addEventListener("click", () => window.location.href = "projects.html");
